...
def reSize(file):
    ...
    #w, h = image_case.size
    #print("Newer W: " + str(w) + "\nNewer H: " + str(h))
    #!!!!image_case = image_case.crop((0,0,(w-(w%dW)),(h-(h%dH))))#HECKA IMPORTANT
    
    #CANVAS SIZE MUST BE FIXED AFTER ROTATION
    #!!!!image_case = image_case.resize( (dW,dH), resample=0 )#HECKA IMPORTANT
    w, h = image_case.size
    print("Super W: " + str(w) + "\nSuper H: " + str(h))
